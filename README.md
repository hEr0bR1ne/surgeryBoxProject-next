...
> **2026-09-11 上位机联调交接：电机输出已在源码中禁用（MOTOR_OUTPUT_ENABLED=false），Winding及全部电机测试命令均拒绝。舵机、编码器和血迹灯保留。实际烧录状态见 docs/main-firmware-restoration.md；最新交接见 docs/AI-HANDOFF.md。不要恢复电机测试固件或通过串口尝试解锁。**
